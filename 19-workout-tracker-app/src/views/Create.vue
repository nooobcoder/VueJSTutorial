<template>
  <div class="max-w-screen-md mx-auto px-4 py-10">
    ...
    <div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg">
      <!-- Form -->
      <form
        @submit.prevent="methods.createWorkout"
      ...
      >
        ...
        <div v-if="workoutType === 'strength'" class="flex flex-col gap-y-4">
          ...
          <button
            @click.prevent="methods.addExercise"
            type="button"
            class="
              mt-6
              py-2
        ...
        <div v-if="workoutType === 'cardio'" class="flex flex-col gap-y-4">
          ...
          >
            ...
            <img
              @click.prevent="methods.deleteExercise(item.id)"
              src="@/assets/images/trash-light-green.png"
              class="h-4 w-auto absolute -left-5 cursor-pointer"
              alt=""
            />
...
export default {
  ...
  setup() {
    // Create data
    const workoutCreateObj = reactive({
      workoutName: "",
    ...
    const { workoutName, workoutType, exercises } = toRefs(workoutCreateObj);
